...
function MobileNav({ session, menus, pathname, onNavigate }: { session: SessionInfo; menus: WorkbookMenu[]; pathname: string; onNavigate: () => void }) {
  const links = [["/parts", "Parts"], ["/parts/stock-in", "Stock IN"], ["/parts/stock-out", "Stock OUT"], ["/parts/transactions", "Transactions"], ["/machines", "Machines"], ["/employees", "Employees"], ["/reports", "Reports"]];
